...
class LlamaEngine @Inject constructor() {
    ...
    suspend fun generateWithImage(
        ...
        try {
            ...
            isGenerating = true
            val response = nativeGenerateWithImage(prompt, imagePath, maxTokens, temperature, topP, topK)
            isGenerating = false
    ...
    suspend fun generateStreamWithImage(
        ...
        try {
            ...
            try {
                nativeGenerateStreamWithImage(prompt, imagePath, maxTokens, temperature, topP, topK, callback)
            } catch (e: Exception) {
