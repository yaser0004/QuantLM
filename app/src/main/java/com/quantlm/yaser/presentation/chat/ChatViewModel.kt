    ...
    private fun updateVisionModelState() {
        ...
        val downloadedVisionModels = allVisionModels.filter { visionModel ->
            ...
            val isMmprojDownloaded = if (!requiresMmproj) {
                true
            } else if (mmprojFile?.exists() == true) {
        ...
        val defaultVisionModel = allVisionModels.minByOrNull { it.fileSize } ?: AvailableModels.SMOLVLM_256M_F16
    ...
    fun getVisionModel(): DownloadableModel {
        ...
        return when (state) {
            ...
            VisionModelState.Ready -> {
                ...
                allVision.minByOrNull { it.fileSize } ?: AvailableModels.SMOLVLM_256M_F16
            }
        }
    }
